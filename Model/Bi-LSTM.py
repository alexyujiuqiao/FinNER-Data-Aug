...
from tensorflow.keras.layers import Layer, Embedding, LSTM, Dense, Input, Bidirectional, TimeDistributed
...
LSTM layer: 100 hiden units (forget gate + input gate + output gate)
